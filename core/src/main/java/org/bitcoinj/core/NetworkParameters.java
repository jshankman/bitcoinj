...
public abstract class NetworkParameters implements Serializable {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            t.addOutput(new TransactionOutput(n, t, TEN_COINS, scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
    ...
    public static final int TARGET_TIMESPAN =  4* 60 * 60;  // 4 hours per difficulty cycle, on average.
